 ...
 * 
 */
@WebServiceClient(name = "FileWSService", targetNamespace = "http://logic.midd/", wsdlLocation = "http://localhost:8080/WS-Files/FileWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FILEWSSERVICE_QNAME = new QName("http://logic.midd/", "FileWSService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WS-Files/FileWS?wsdl");
    ...
    public IFileWS getFileWSPort() {
        return super.getPort(new QName("http://logic.midd/", "FileWSPort"), IFileWS.class);
    }
     ...
     */
    @WebEndpoint(name = "FileWSPort")
    public IFileWS getFileWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://logic.midd/", "FileWSPort"), IFileWS.class, features);
    }
